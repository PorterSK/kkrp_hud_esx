...
function createCycle()
    ...
    local speedType = (vehicleType ~= "plane" and "MP/H" or "Knots")
...
RegisterKeyMapping('togglebigmap','Velká mapa ve vozidle','keyboard','LSHIFT')
RegisterKeyMapping('belt','Bezpečnostní pás','keyboard','B')
RegisterKeyMapping('cruiser','Omezovač rychlosti','keyboard','Y')
